...
public class GameManagerController : MonoBehaviour {
    public static GameManagerController Instanciate;
    ...
    [HideInInspector] public bool WindCheat;
    ...
    public void InstanciateWind()
    {
        ...
        if (AuxInstanciateWindTimer >= InstanciateWindTimer && !PlayerController.Instanciate.GameOver && !WindCheat)
        {
